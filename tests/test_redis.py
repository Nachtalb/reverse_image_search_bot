...
class MockedRedisStorage(RedisStorage):
    # This is purely to stop mypy from complaining about the redis_client
...
class TestRedisStorage:
    ...
    async def setup_method(self, mock_redis_client: AsyncMock) -> None:
        ...
        self.redis: MockedRedisStorage = RedisStorage(mock_redis_client)  # type: ignore[assignment]
